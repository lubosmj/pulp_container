...
CREATE_USER_CMD = [
    ...
    "",
    "for permission, obj_name in {object_permissions!r}:",
    "    obj = ContainerDistribution.objects.filter(name=obj_name)",
...
def gen_user(model_permissions, object_permissions=None):
