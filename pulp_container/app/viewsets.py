    ...
    DEFAULT_ACCESS_POLICY = {
        "statements": [
            ...
            },
            {
                ...
                "condition_expression": [
                    "not is_private "
                    "or has_namespace_or_obj_perms:container.view_containerpullthroughdistribution",
                ],
            },
            {
                "action": ["update", "partial_update"],
        ...
        "queryset_scoping": {
            "function": "get_dist_qs",
            "parameters": {
                "ns_perm": "container.view_containerpullthroughnamespace",
                "dist_perm": "container.view_containerpullthroughdistribution",
            },
        },
    }
    LOCKED_ROLES = {
